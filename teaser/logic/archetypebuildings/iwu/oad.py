...
class Oad(NonResidential):
    """Archetype Office, administrative, or government building according to IWU Non Residential Typology building type 1.

    Subclass from NonResidential archetype class to represent office buildings.

    The office module contains a single zone building according to IWU (see https://github.com/IWUGERMANY/Nichtwohngebaeude-Typologie-Deutschland).

    This office contains 1 usage zone. 
    It has 4 outer walls, 4 windows, a flat roof and a ground floor. Interior wall
